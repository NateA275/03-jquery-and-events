...
// DONE: Configure an object to hold all of our functions for dynamic updates and article-related event handlers.
let articleView = {};

articleView.populateFilters = function() {
  $('article').each(function() {
    // DONE: We can declare several variables at once and assign their values later when using let. Keep in mind that we cannot do this with const.
...
articleView.handleMainNav = function() {
  ...
  // DONE: Now trigger a click on the first .tab element, to set up the page.
...
articleView.setTeasers = function() {
  ...
  // TODO: Add an event handler to reveal all the hidden elements, when the .read-on link is clicked.
